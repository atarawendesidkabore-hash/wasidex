...
- Fund name: `LESEX Fund`
- Full name: `Lesotho Raw Export Index Fund`
- Benchmark: `Lesotho Raw Export Index`
- Fund family: `AFEX`
- Regional subfamily: `SAEX`
- Base currency: `LSL`
...
- Lesotho should carry a small-market caution and focus on wool, mohair, and diamonds.
